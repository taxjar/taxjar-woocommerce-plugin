...
class TaxJar_WC_Unit_Tests_Bootstrap
{
    ...
    public function __construct() 
    {
        ...
        include_once $this->wp_tests_dir . '/includes/functions.php';
        ...
        include_once $this->wp_tests_dir . '/includes/bootstrap.php';
    ...
    {
        // load woocommerce
        include_once $this->plugin_dir . 'woocommerce/woocommerce.php';

        // load taxjar core
        update_option('active_plugins', array( 'woocommerce/woocommerce.php' ));
        update_option('woocommerce_db_version', WC_VERSION);
        include_once $this->plugin_dir . 'taxjar-woocommerce-plugin/taxjar-woocommerce.php';
    ...
    {
        // load framework
        include_once $this->tests_dir . '/framework/woocommerce-helper.php';
        include_once $this->tests_dir . '/framework/coupon-helper.php';
        include_once $this->tests_dir . '/framework/customer-helper.php';
        include_once $this->tests_dir . '/framework/product-helper.php';
        include_once $this->tests_dir . '/framework/shipping-helper.php';
        include_once $this->tests_dir . '/framework/wp-http-testcase.php';
        include_once $this->tests_dir . '/framework/subscription-helper.php';
        include_once $this->tests_dir . '/framework/order-helper.php';
    }
